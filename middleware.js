...
const ROUTES = {
  ...
  "/illustration/pokerstars-vr": {
    ...
    "desc": "A custom logo and illustration project created for PokerStars VR, featuring themed visual identities designed for monthly in-game content releases. Each lo",
  ...
  "/illustration/real-fruit": {
    ...
    "desc": "A series of custom environmental illustrations developed for Real Fruit Bubble Tea across two themed retail locations. Each store featured a unique narrati",
  ...
  "/illustration/baitme": {
    "title": "Baitme | Shuang",
    "desc": "An illustration-led awareness campaign using narrative storytelling and digital animation to communicate online privacy risks, recognized with an RGD Stude",
    "image": "images/illustration/baitme/banner/baitme-cover.webp",
    "type": "illustration"
  },
  "/illustration/66-day-gifs": {
    "title": "66 Day Gifs | Shuang",
    "desc": "A self-initiated 66-day animation challenge featuring short hand-drawn GIFs centered around cute animal characters and word-based visual concepts. Each ani",
  ...
  "/illustration/poker-card-back-design": {
    ...
    "desc": "A collection of custom poker card back designs created for PokerStars VR. Each design was developed around different themed content releases, combining ill",
  ...
  "/illustration/vr-thematic-wall": {
    ...
    "desc": "A collection of thematic wall illustrations created for PokerStars VR to support immersive in-game environments. Each visual was developed around different",
...
export default async function handler(request) {
  ...
  if (!BOT_RE.test(ua)) {
    // Real user — fetch and return the actual index.html
